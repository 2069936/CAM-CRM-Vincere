...
describe('admin route dispatcher', () => {
  it.each(['client-export', 'ingest-batches', 'ingest-download', 'ingest-enrollment', 'ingest-fleet', 'ingest-reprocess', 'ingest-status', 'ingest-verify'])('preserves /api/admin/%s', (action) => {
